...
public class Messages {
    ...
    public static void register() {
        ...
        net.messageBuilder(CustomPacketManager.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                .decoder(CustomPacketManager::new)
                .encoder(CustomPacketManager::toBytes)
                .consumerMainThread(CustomPacketManager::handle)
                .add();
